use crate::{
    blog_content::{
        self, is_markdown_file, read_blog_note_detail, scan_notes_dir, BlogNote, BlogNoteDetail,
    },
    blog_service::{read_effective_blog_config, render_blog_config_api_json, render_json_error},
    luogu::{read_config, write_config, BlogConfigFields},
    paths,
};
...
fn render_notes_api_json() -> Result<String, String> {
    blog_content::render_notes_api_json()
}
...
fn render_note_api_json(request_target: &str) -> Result<String, String> {
    ...
    blog_content::render_note_api_json(&note_path, &notes_dir)
}
...
mod tests {
    use super::*;
    use crate::blog_content::NoteFrontmatter;
    use std::fs;
