...
const createUnavailablePermissionStates = (): WorkbenchTaskPermissionRequest[] => [
  ...
  },
  {
    ...
    toolName: "workspace_writer",
    permission: "write",
    status: "blocked",
    reason: "Workbench write actions require an explicit user approval step.",
  },
  {
    ...
    permission: "execute",
    status: "blocked",
    reason: "Code execution is outside the P4 reader/evidence slice and remains blocked.",
  },
];
