            ...
            <div className="grid min-w-0 max-w-full gap-3 border-l border-border/80 pl-3 text-xs leading-5">
              ...
              <div className="grid min-w-0 grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-4">
                {[
                  ...
                  ["目标读取来源数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "targetReadCount") ?? "none"],
                  ["尝试读取来源数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "attemptedReadCount") ?? String(researchEngineRealShadowRun.readAttempts.length)],
                  ...
                  ["可用正文证据数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "usableBodyEvidenceCount") ?? researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "usableEvidenceCount") ?? "none"],
                  ["可用近期正文证据数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "usableFreshBodyEvidenceCount") ?? "none"],
                  ["当前日期", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "currentDate") ?? "none"],
                  ["时效窗口天数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "freshnessWindowDays") ?? "none"],
                  ["时效性门控状态", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "freshnessGateStatus") ?? "none"],
                  ["时效性失败原因", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "freshnessFailureReason") ?? "none"],
                  ["近期正文证据数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "freshEvidenceCount") ?? "none"],
                  ["旧资料数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "staleEvidenceCount") ?? "none"],
                  ["日期不明资料数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "unknownDateEvidenceCount") ?? "none"],
                  ["因时效性拒绝数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "rejectedByFreshnessCount") ?? "none"],
                  ...
                  ["可用证据来源数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "usableEvidenceHostCount") ?? "none"],
                  ["证据门控状态", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "evidenceGateStatus") ?? "none"],
                  ...
                  ["综合条目数", researchEngineDiagnosticText(researchEngineRealShadowRun.diagnosticsSnapshot, "synthesisPlanItemCount") ?? "none"],
