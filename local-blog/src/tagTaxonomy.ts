...
export const BUILTIN_TAG_TAXONOMY: TagTaxonomyEntry[] = [
  ...
  tagEntry("algorithm.group.dp", "算法/动态规划"),
  tagEntry("algorithm.group.dp-optimization", "算法/动态规划优化"),
  tagEntry("algorithm.group.search", "算法/搜索与随机化"),
  tagEntry("algorithm.group.graph", "算法/图论"),
  tagEntry("algorithm.group.tree", "算法/树论"),
  tagEntry("algorithm.group.data-structure", "算法/数据结构"),
  ...
  tagEntry("algorithm.basic.discretization", "算法/基础算法/离散化", ["离散化"]),
  tagEntry("algorithm.basic.scanline", "算法/基础算法/扫描线", ["扫描线"]),
  tagEntry("algorithm.basic.bit-operation", "算法/基础算法/位运算", ["位运算"]),
  tagEntry("algorithm.basic.construction", "算法/基础算法/构造", ["构造"]),
  tagEntry("algorithm.basic.two-pointer", "算法/基础算法/双指针", ["双指针", "two-pointer"]),
  tagEntry("algorithm.basic.ad-hoc", "算法/基础算法/Ad-hoc", ["Ad-hoc"]),
  tagEntry("algorithm.basic.prefix-sum", "算法/基础算法/前缀和", ["前缀和"]),
  tagEntry("algorithm.basic.difference", "算法/基础算法/差分", ["差分"]),

  tagEntry("algorithm.string.string", "算法/字符串/字符串", ["字符串"]),
  tagEntry("algorithm.string.kmp", "算法/字符串/KMP", ["KMP", "KMP 算法"]),
  ...
  tagEntry("algorithm.string.manacher", "算法/字符串/Manacher", ["Manacher", "Manacher 算法"]),
  ...
  tagEntry("algorithm.string.hashing", "算法/字符串/字符串哈希", ["字符串 Hash", "string hashing"]),

  tagEntry("algorithm.dp.dp", "算法/动态规划/DP", ["DP", "动态规划", "动态规划 DP"]),
  tagEntry("algorithm.dp.knapsack", "算法/动态规划/背包 DP", ["背包", "背包 DP"]),
  tagEntry("algorithm.dp.digit", "算法/动态规划/数位 DP", ["数位 DP"]),
  tagEntry("algorithm.dp.interval", "算法/动态规划/区间 DP", ["区间 DP"]),
  tagEntry("algorithm.dp.tree", "算法/动态规划/树形 DP", ["树形 DP"]),
  tagEntry("algorithm.dp.plug", "算法/动态规划/轮廓线 DP", ["轮廓线 DP"]),
  tagEntry("algorithm.dp.linear", "算法/动态规划/线性 DP", ["线性 DP"]),
  tagEntry("algorithm.dp.state-compression", "算法/动态规划/状压 DP", ["状压 DP"]),
  tagEntry("algorithm.dp.probability", "算法/动态规划/概率 DP", ["概率 DP"]),
  tagEntry("algorithm.dp.counting", "算法/动态规划/计数 DP", ["计数 DP"]),
  tagEntry("algorithm.dp.plug-dp", "算法/动态规划/插头 DP", ["插头 DP"]),
  ...
  tagEntry("algorithm.dp.optimization.wqs-binary-search", "算法/动态规划优化/wqs 二分", ["wqs 二分", "凸完全单调性"]),
  ...
  tagEntry("algorithm.dp.optimization.slope-trick", "算法/动态规划优化/slope trick", ["slope trick", "斜率维护技巧"]),
  tagEntry("algorithm.dp.optimization.monotone-queue", "算法/动态规划优化/单调队列优化 DP", ["单调队列优化"]),
  tagEntry("algorithm.dp.optimization.data-structure", "算法/动态规划优化/数据结构优化 DP", ["数据结构优化 DP"]),

  tagEntry("algorithm.search.search", "算法/搜索与随机化/搜索", ["搜索"]),
  tagEntry("algorithm.search.bfs", "算法/搜索与随机化/BFS", ["BFS", "广度优先搜索"]),
  tagEntry("algorithm.search.dfs", "算法/搜索与随机化/DFS", ["DFS", "深度优先搜索"]),
  tagEntry("algorithm.search.pruning", "算法/搜索与随机化/剪枝", ["剪枝"]),
  tagEntry("algorithm.search.memoized-search", "算法/搜索与随机化/记忆化搜索", ["记忆化搜索"]),
  tagEntry("algorithm.search.heuristic-search", "算法/搜索与随机化/启发式搜索", ["启发式搜索"]),
  tagEntry("algorithm.search.iterative-deepening", "算法/搜索与随机化/迭代加深", ["迭代加深"]),
  tagEntry("algorithm.search.ida-star", "算法/搜索与随机化/IDA*", ["IDA*", "启发式迭代加深搜索", "IDA star"]),
  tagEntry("algorithm.search.dancing-links", "算法/搜索与随机化/Dancing Links", ["Dancing Links", "DLX"]),
  tagEntry("algorithm.search.hill-climbing", "算法/搜索与随机化/爬山算法", ["爬山", "爬山算法", "Local search"]),
  tagEntry("algorithm.search.simulated-annealing", "算法/搜索与随机化/模拟退火", ["模拟退火"]),
  tagEntry("algorithm.search.genetic-algorithm", "算法/搜索与随机化/遗传算法", ["遗传算法"]),
  tagEntry("algorithm.search.a-star", "算法/搜索与随机化/A*", ["A*", "A* 算法", "A star"]),
  tagEntry("algorithm.search.meet-in-the-middle", "算法/搜索与随机化/折半搜索", ["折半搜索", "meet in the middle", "MITM"]),
  tagEntry("algorithm.search.random-adjustment", "算法/搜索与随机化/随机调整", ["随机调整"]),
  tagEntry("algorithm.search.randomization", "算法/搜索与随机化/随机化", ["随机化"]),
  tagEntry("algorithm.search.gradient-descent", "算法/搜索与随机化/梯度下降法", ["梯度下降法"]),
  ...
  tagEntry("algorithm.graph.general-graph-matching", "算法/图论/一般图最大匹配", ["一般图最大匹配", "一般图的最大匹配", "带花树"]),
  tagEntry("algorithm.graph.block-cut-tree", "算法/图论/圆方树", ["圆方树"]),
  tagEntry("algorithm.graph.chordal-graph", "算法/图论/弦图", ["弦图"]),
  tagEntry("algorithm.graph.floyd", "算法/图论/Floyd", ["Floyd", "Floyd 算法"]),
  ...
  tagEntry("algorithm.tree.lca", "算法/树论/LCA", ["LCA", "最近公共祖先", "最近公共祖先 LCA"]),
  ...
  tagEntry("algorithm.data-structure.data-structure", "算法/数据结构/数据结构", ["数据结构"]),
  tagEntry("algorithm.data-structure.segment-tree", "算法/数据结构/线段树", ["线段树"]),
  tagEntry("algorithm.data-structure.disjoint-set", "算法/数据结构/并查集", ["并查集", "DSU", "Union-Find"]),
  tagEntry("algorithm.data-structure.balanced-tree", "算法/数据结构/平衡树", ["平衡树"]),
  tagEntry("algorithm.data-structure.heap", "算法/数据结构/堆", ["堆"]),
  tagEntry("algorithm.data-structure.binary-indexed-tree", "算法/数据结构/树状数组", ["树状数组", "BIT", "Fenwick Tree"]),
  tagEntry("algorithm.data-structure.cdq-divide-and-conquer", "算法/数据结构/cdq 分治", ["cdq 分治", "CDQ 分治"]),
  tagEntry("algorithm.data-structure.mergeable-heap", "算法/数据结构/可并堆", ["可并堆"]),
  tagEntry("algorithm.data-structure.lct", "算法/数据结构/动态树 LCT", ["LCT", "动态树", "动态树 LCT", "Link-Cut Tree"]),
  tagEntry("algorithm.data-structure.tree-of-tree", "算法/数据结构/树套树", ["树套树"]),
  tagEntry("algorithm.data-structure.persistent-segment-tree", "算法/数据结构/可持久化线段树", ["可持久化线段树", "主席树"]),
  tagEntry("algorithm.data-structure.persistent-data-structure", "算法/数据结构/可持久化数据结构", ["可持久化"]),
  tagEntry("algorithm.data-structure.overall-binary-search", "算法/数据结构/整体二分", ["整体二分"]),
  tagEntry("algorithm.data-structure.kd-tree", "算法/数据结构/K-D Tree", ["K-D Tree", "KD Tree"]),
  tagEntry("algorithm.data-structure.li-chao-segment-tree", "算法/数据结构/李超线段树", ["李超树", "李超线段树"]),
  tagEntry("algorithm.data-structure.segment-tree-beats", "算法/数据结构/segment tree beats", ["吉司机线段树", "segment tree beats", "Segment Tree Beats", "STB"]),
  tagEntry("algorithm.data-structure.segment-tree-merge", "算法/数据结构/线段树合并", ["线段树合并"]),
  tagEntry("algorithm.data-structure.cat-tree", "算法/数据结构/猫树分治", ["猫树", "猫树分治", "二区间合并"]),
  tagEntry("algorithm.data-structure.ktt", "算法/数据结构/KTT", ["KTT", "Kinetic Tournament Tree"]),
  tagEntry("algorithm.data-structure.monotone-queue", "算法/数据结构/单调队列", ["单调队列"]),
  tagEntry("algorithm.data-structure.stack", "算法/数据结构/栈", ["栈"]),
  tagEntry("algorithm.data-structure.queue", "算法/数据结构/队列", ["队列"]),
  tagEntry("algorithm.data-structure.block", "算法/数据结构/分块", ["分块"]),
  tagEntry("algorithm.data-structure.sparse-table", "算法/数据结构/ST 表", ["ST 表"]),
  tagEntry("algorithm.data-structure.linked-list", "算法/数据结构/链表", ["链表"]),
  tagEntry("algorithm.data-structure.monotone-stack", "算法/数据结构/单调栈", ["单调栈"]),
  tagEntry("algorithm.data-structure.hash-table", "算法/数据结构/哈希表", ["哈希表"]),
  tagEntry("algorithm.data-structure.odt", "算法/数据结构/珂朵莉树 ODT", ["ODT", "珂朵莉树", "颜色段均摊"]),

  tagEntry("algorithm.math.math", "算法/数学/数学", ["数学"]),
  tagEntry("algorithm.math.number-theory", "算法/数学/数论", ["数论"]),
  tagEntry("algorithm.math.prime-test", "算法/数学/素数判断", ["素数", "质数"]),
  tagEntry("algorithm.math.sieve", "算法/数学/筛法", ["筛法"]),
  tagEntry("algorithm.math.gcd", "算法/数学/gcd", ["gcd", "最大公约数"]),
  tagEntry("algorithm.math.extended-euclidean", "算法/数学/扩展欧几里德算法", ["扩展欧几里德", "扩展欧几里德算法", "exgcd"]),
  tagEntry("algorithm.math.diophantine-equation", "算法/数学/不定方程", ["不定方程"]),
  tagEntry("algorithm.math.base-conversion", "算法/数学/进制", ["进制"]),
  tagEntry("algorithm.math.crt", "算法/数学/CRT", ["中国剩余定理", "中国剩余定理 CRT", "CRT"]),
  tagEntry("algorithm.math.mobius-inversion", "算法/数学/莫比乌斯反演", ["莫比乌斯反演"]),
  tagEntry("algorithm.math.inverse", "算法/数学/逆元", ["逆元"]),
  tagEntry("algorithm.math.lucas", "算法/数学/Lucas 定理", ["Lucas", "Lucas 定理"]),
  tagEntry("algorithm.math.euclidean-like", "算法/数学/类欧几里得算法", ["类欧几里得"]),
  tagEntry("algorithm.math.harmonic-series", "算法/数学/调和级数", ["调和级数"]),
  tagEntry("algorithm.math.euler-power-reduction", "算法/数学/欧拉降幂", ["欧拉降幂"]),
  tagEntry("algorithm.math.stern-brocot-tree", "算法/数学/Stern-Brocot 树", ["Stern-Brocot 树"]),
  tagEntry("algorithm.math.divisor-block", "算法/数学/整除分块", ["整除分块"]),
  tagEntry("algorithm.math.dirichlet-convolution", "算法/数学/Dirichlet 卷积", ["Dirichlet 卷积"]),
  tagEntry("algorithm.math.euler-function", "算法/数学/欧拉函数", ["欧拉函数"]),
  tagEntry("algorithm.math.bsgs", "算法/数学/BSGS", ["BSGS", "大步小步算法"]),
  tagEntry("algorithm.math.quadratic-residue", "算法/数学/二次剩余", ["二次剩余"]),
  tagEntry("algorithm.math.bezout-theorem", "算法/数学/Bézout 定理", ["Bezout 定理", "贝祖定理"]),
  tagEntry("algorithm.math.du-sieve", "算法/数学/杜教筛", ["杜教筛"]),
  tagEntry("algorithm.math.combinatorics", "算法/数学/组合数学", ["组合数学"]),
  tagEntry("algorithm.math.permutation-combination", "算法/数学/排列组合", ["排列组合"]),
  tagEntry("algorithm.math.binomial-theorem", "算法/数学/二项式定理", ["二项式定理"]),
  tagEntry("algorithm.math.cantor-expansion", "算法/数学/康托展开", ["康托展开"]),
  tagEntry("algorithm.math.pigeonhole-principle", "算法/数学/鸽笼原理", ["鸽笼原理"]),
  tagEntry("algorithm.math.inclusion-exclusion", "算法/数学/容斥原理", ["容斥原理"]),
  tagEntry("algorithm.math.fibonacci", "算法/数学/Fibonacci 数列", ["Fibonacci"]),
  tagEntry("algorithm.math.catalan", "算法/数学/Catalan 数", ["Catalan"]),
  tagEntry("algorithm.math.stirling", "算法/数学/Stirling 数", ["Stirling"]),
  tagEntry("algorithm.math.generating-function", "算法/数学/生成函数", ["生成函数"]),
  tagEntry("algorithm.math.dilworth-theorem", "算法/数学/Dilworth 定理", ["Dilworth 定理"]),
  tagEntry("algorithm.math.lagrange-inversion", "算法/数学/拉格朗日反演", ["拉格朗日反演"]),
  tagEntry("algorithm.math.young-tableau", "算法/数学/杨表", ["杨表"]),
  tagEntry("algorithm.math.probability", "算法/数学/概率论", ["概率论"]),
  tagEntry("algorithm.math.expectation", "算法/数学/期望", ["期望"]),
  tagEntry("algorithm.math.probability-generating-function", "算法/数学/概率生成函数", ["概率生成函数"]),
  tagEntry("algorithm.math.random-walk", "算法/数学/随机游走", ["随机游走"]),
  tagEntry("algorithm.math.markov-chain", "算法/数学/Markov Chain", ["Markov Chain", "马尔可夫链"]),
  tagEntry("algorithm.math.optional-stopping-theorem", "算法/数学/鞅的停时定理", ["鞅的停时定理"]),
  tagEntry("algorithm.math.linear-algebra", "算法/数学/线性代数", ["线性代数"]),
  tagEntry("algorithm.math.lgv-lemma", "算法/数学/LGV 引理", ["LGV 引理"]),
  tagEntry("algorithm.math.matrix-tree-theorem", "算法/数学/矩阵树定理", ["矩阵树定理"]),
  tagEntry("algorithm.math.matrix-operation", "算法/数学/矩阵运算", ["矩阵运算"]),
  tagEntry("algorithm.math.matrix-multiplication", "算法/数学/矩阵乘法", ["矩阵乘法"]),
  tagEntry("algorithm.math.linear-recurrence", "算法/数学/线性递推", ["线性递推"]),
  tagEntry("algorithm.math.gaussian-elimination", "算法/数学/高斯消元", ["高斯消元"]),
  tagEntry("algorithm.math.linear-basis", "算法/数学/线性基", ["线性基"]),
  tagEntry("algorithm.math.determinant", "算法/数学/行列式", ["行列式"]),
  tagEntry("algorithm.math.eigenvalue", "算法/数学/特征值", ["特征值"]),
  tagEntry("algorithm.math.group-theory", "算法/数学/群论", ["群论"]),
  tagEntry("algorithm.math.permutation", "算法/数学/置换", ["置换"]),
  tagEntry("algorithm.math.polya", "算法/数学/Pólya 定理", ["Pólya", "Polya 定理"]),
  tagEntry("algorithm.math.calculus", "算法/数学/微积分", ["微积分"]),
  tagEntry("algorithm.math.derivative", "算法/数学/导数", ["导数"]),
  tagEntry("algorithm.math.integral", "算法/数学/积分", ["积分"]),
  tagEntry("algorithm.math.series", "算法/数学/级数", ["级数"]),
  ...
  tagEntry("algorithm.game-theory.nim", "算法/博弈论/Nim", ["Nim", "Nim 积"]),
  tagEntry("algorithm.game-theory.sg-function", "算法/博弈论/SG 函数", ["SG 函数"]),

  tagEntry("algorithm.polynomial.polynomial", "算法/多项式/多项式", ["多项式"]),
  tagEntry("algorithm.polynomial.fft", "算法/多项式/FFT", ["FFT", "快速傅里叶变换"]),
  tagEntry("algorithm.polynomial.ntt", "算法/多项式/NTT", ["NTT", "快速数论变换"]),
  tagEntry("algorithm.polynomial.fwt", "算法/多项式/FWT", ["FWT", "快速沃尔什变换"]),
  tagEntry("algorithm.polynomial.fmt", "算法/多项式/FMT", ["FMT", "快速莫比乌斯变换"]),
  tagEntry("algorithm.polynomial.berlekamp-massey", "算法/多项式/Berlekamp-Massey", ["BM", "Berlekamp-Massey", "Berlekamp-Massey(BM) 算法"]),
  tagEntry("algorithm.polynomial.set-power-series", "算法/多项式/集合幂级数", ["集合幂级数"]),
  tagEntry("algorithm.polynomial.subset-convolution", "算法/多项式/子集卷积", ["子集卷积"]),
  ...
  tagEntry("algorithm.geometry.minkowski-sum", "算法/计算几何/闵可夫斯基和", ["闵可夫斯基和", "Minkowski sum"]),
  ...
  tagEntry("algorithm.misc.hashing", "算法/其它技巧/哈希", ["哈希", "hashing", "hash"]),
  tagEntry("algorithm.misc.randomization", "算法/其它技巧/随机化", ["随机化技巧"]),
...
export function normalizeTagToTaxonomyPath(tag: string) {
  const entry = resolvedTagTaxonomy.aliasMap.get(normalizeTagAliasKey(tag));
  return entry ? getTagPathText(entry.path) : null;
}

function findCanonicalEntryForSegments(segments: string[]) {
  const fullPath = getTagPathText(segments);
  const fullPathEntry = resolvedTagTaxonomy.pathMap.get(normalizeTagAliasKey(fullPath));
  if (fullPathEntry) {
  ...
  if (
    segments.length > 1 &&
    resolvedTagTaxonomy.entries.some(
  ...
  return leaf ? resolvedTagTaxonomy.aliasMap.get(normalizeTagAliasKey(leaf)) ?? null : null;
}

export function normalizeTagPath(tag: string): NormalizedTagPath | null {
  const segments = splitTagSegments(tag);
  if (segments.length === 0) {
    return null;
  }

  const canonicalEntry = findCanonicalEntryForSegments(segments);
...
export function getTagSuggestionList(): TagSuggestion[] {
  const seen = new Set<string>();

  return resolvedTagTaxonomy.entries.flatMap((entry) => {
...
function compareTagSuggestions(a: TagSuggestion, b: TagSuggestion) {
  const orderA = resolvedTagTaxonomy.displayOrder.get(a.id) ?? Number.MAX_SAFE_INTEGER;
  const orderB = resolvedTagTaxonomy.displayOrder.get(b.id) ?? Number.MAX_SAFE_INTEGER;
...
export function createTagCompletionContext(): TagCompletionContext {
  const flat = getTagSuggestionList().filter((item) => !item.hidden).sort(compareTagSuggestions);
  ...
  const groups = Array.from(groupLookup.values()).map((group) => ({
    ...
    groups: group.groups.map((subgroup) => ({
      ...subgroup,
      candidates: subgroup.candidates.sort(compareTagSuggestions),
    })),
    candidates: group.candidates.sort(compareTagSuggestions),
  }));
...
export function findTagSuggestionsByQuery(query: string, options: FindTagSuggestionsOptions = {}) {
  ...
  const scored = getTagSuggestionList()
    ...
    .sort((a, b) => b.score - a.score || compareTagSuggestions(a.suggestion, b.suggestion));
  const seen = new Set<string>();
...
export function suggestTagsFromArticleText(
  ...
  const existingIds = new Set(
    (input.existingTags ?? [])
      .map((tag) => normalizeTagPath(tag)?.entryId)
      .filter((id): id is string => Boolean(id)),
  );
  const scored = new Map<string, ArticleTagSuggestion>();

  for (const suggestion of getTagSuggestionList()) {
  ...
  return Array.from(scored.values())
    .sort((a, b) => b.score - a.score || compareTagSuggestions(a.tag, b.tag))
    .slice(0, limit);
}
...
export function runTagTaxonomySelfCheck(): TagTaxonomySelfCheckResult {
  ...
  addSelfCheck(checks, "DP aliases to dynamic programming", normalizedPath("DP"), "算法/动态规划/DP");
  addSelfCheck(checks, "李超树 aliases to 李超线段树", normalizedPath("李超树"), "算法/数据结构/李超线段树");
  ...
  addSelfCheck(checks, "主席树 aliases to 可持久化线段树", normalizedPath("主席树"), "算法/数据结构/可持久化线段树");
  addSelfCheck(checks, "STB aliases to segment tree beats", normalizedPath("STB"), "算法/数据结构/segment tree beats");
  addSelfCheck(checks, "FFT stays in polynomial taxonomy", normalizedPath("FFT"), "算法/多项式/FFT");
  addSelfCheck(checks, "NTT stays in polynomial taxonomy", normalizedPath("NTT"), "算法/多项式/NTT");
  addSelfCheck(checks, "gcd aliases to gcd", normalizedPath("gcd"), "算法/数学/gcd");
  addSelfCheck(checks, "exgcd aliases to 扩展欧几里德算法", normalizedPath("exgcd"), "算法/数学/扩展欧几里德算法");
  addSelfCheck(checks, "CRT aliases to CRT", normalizedPath("CRT"), "算法/数学/CRT");
  addSelfCheck(checks, "two-pointer aliases to 双指针", normalizedPath("two-pointer"), "算法/基础算法/双指针");
  ...
  addSelfCheck(checks, "query 主席树 returns 可持久化线段树", firstQueryPath("主席树"), "算法/数据结构/可持久化线段树");
  addSelfCheck(checks, "query STB returns segment tree beats", firstQueryPath("STB"), "算法/数据结构/segment tree beats");
