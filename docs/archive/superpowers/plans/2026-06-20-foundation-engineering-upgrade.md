...
- `53fc383 refactor(luogu): centralize prepare progress helpers`
- `f20dcb7 refactor(luogu): centralize write progress helpers`
- `eb8551f refactor(search): centralize local index rebuild messages`
